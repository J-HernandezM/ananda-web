...
export default function CheckoutForm({ setFieldValue }: CheckoutFormProps) {
  ...
  const handleDepartmentChange = (e: InputEvent) => {
    ...
    fetch(`https://api-colombia.com/api/v1/Department/${regionId}/cities`)
      ...
      .catch(error => {
        console.error('Error with Colombia-API fetching cities: ', error);
      });
  };

  const handleNumericInputChange = (e: InputEvent) => {
    ...
    <Form className="form">
      <div className="form--data-user">
        ...
        <div className="form--field">
          ...
          <ErrorMessage name="lastname" className="form--error" component={'span'}></ErrorMessage>
        </div>
        <div className="form--field">
        ...
        <div className="form--field">
          ...
          <Field onChange={handleNumericInputChange} type="tel" id="phone" name="phone" />
      ...
      <div className="form--data-address">
        <div className="form--field">
          ...
          <Field onChange={handleDepartmentChange} id="region" name="region" as="select">
        ...
        <div className="form--field field--address">
          ...
          <Field type="text" id="address" name="address" placeholder="Dirección completa"></Field>
          <ErrorMessage name="address" className="form--error" component={'span'}></ErrorMessage>
          <Field
            type="text"
